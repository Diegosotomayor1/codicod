export const messageHTML = (name: string, email: string, message: string) => `
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:bottom;" width="100%">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:64px;">
                                                            ...
                                                            <img height="auto" src="https://pcentrix.pe/wp-content/uploads/2024/03/new_pp-1.png" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="64" />
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                                Hola ${name}!<br></br>
                                                Estoy agradecido que tengas el interes de crear o necesitar ayuda en tu proyecto.
                                                </div>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            Tu mensaje fue: ${message} y tu email es:${email}
